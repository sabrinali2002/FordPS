...
function App() {
    ...
    const origButtons = (
        <div className="buttons">
            <button onClick={() => handleUserInput("I")} className="menu">
                Get info about our cars
            </button>
                ...
                if (model === "") {
                    ...
                    setCalcButtons(
                        Object.keys(trims).map((model) => (
                            <button className="calc-button" key={model} value={model} onClick={calcButtonHandler}>
                                {model}
                            </button>
                        ))
                    );
                    ...
                    case "D":
                        ...
                        switch (calcStep) {
                            case 1: //trim
                                ...
                                setCalcButtons(
                                    trims[query].map((trim) => (
                                        <button className="calc-button" key={trim} value={trim} onClick={calcButtonHandler}>
                                            {trim}
                                        </button>
                                    ))
                                );
                            ...
                            case 2: //lease,finance,buy
                                ...
                                setCalcButtons(
                                    options.map((option) => (
                                        <button className="calc-button" style={{ fontSize: "14px" }} key={option} value={option} onClick={calcButtonHandler}>
                                            {option}
                                        </button>
                                    ))
                                );
                                    ...
                                    case 1: // lease
                                        switch (leaseStep) {
                                            ...
                                            case 2: // months
                                                ...
                                                setCalcButtons(
                                                    durations.map((dur) => (
                                                        <button className="calc-button" style={{ fontSize: "14px" }} key={dur.toString()} value={dur} onClick={calcButtonHandler}>
                                                            {dur.toString()}
                                                        </button>
                                                    ))
                                                );
